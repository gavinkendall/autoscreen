...
namespace AutoScreenCapture
{
    public partial class FormMain : Form
    {
        ...
        private void LoadHelpTips()
        {
            ...
            _helpTips.Add("On the right side are modules. This includes Screens, Regions, Editors, Schedules, Macro Tags, and Triggers. You can add, change, or remove various items in each module");
            _helpTips.Add("The Screens module displays a list of screens. Add, remove, or change screens from the Screens module");
            _helpTips.Add("Use the Configure menu to add, change, or remove a Screen or Region. You can add multiple screens and regions each with their own set of attributes");

...
namespace AutoScreenCapture
{
    ...
    public partial class FormMain : Form
    {
        ...
        // The "Region Select Options" dialog box.
        private FormRegionSelectOptions _formRegionSelectOptions;

        // The "Capture Now Options" dialog box.
        private FormCaptureNowOptions _formCaptureNowOptions;
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void emailSettings_Click(object sender, EventArgs e)
        {
            ShowInterface();
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void fileTransferSettings_Click(object sender, EventArgs e)
        {
            ShowInterface();
